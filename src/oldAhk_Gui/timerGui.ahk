...
tmpW70 := cetimer_timerNumFromDpiAndFontSize(3, 5, 70, 80, 90)
tmpW80 := cetimer_timerNumFromDpiAndFontSize(7, 13, 80, 100, 120)
tmpW100 := cetimer_timerNumFromDpiAndFontSize(8, 14, 100, 120, 130)
tmpW110 := cetimer_timerNumFromDpiAndFontSize(9, 15, 110, 130, 150)
tmpW130 := cetimer_timerNumFromDpiAndFontSize(11, 16, 130, 150, 170)
tmpW180 := cetimer_timerNumFromDpiAndFontSize(15, 17, 180, 200, 220)
tmpW200 := cetimer_timerNumFromDpiAndFontSize(16, 18, 200, 220, 240)
tmpW230 := cetimer_timerNumFromDpiAndFontSize(18, 20, 230, 250, 270)
...
tmpW := cetimer_timerNumFromDpiAndFontSize(2, 10, 100, 120, 130)
...
tmpW := cetimer_timerNumFromDpiAndFontSize(3, 8, 45, 55, 65)
...
Gui, 21:Font, S%fontNum12%
tmpW := cetimer_timerNumFromDpiAndFontSize(4, 7, 60, 70, 80)
...
Gui, 21:Font, S%fontNum12%
tmpW := cetimer_timerNumFromDpiAndFontSize(5, 9, 70, 80, 90)
...
tmpNumGroupW := cetimer_timerNumFromDpiAndFontSize(15, 14, 270, 290, 310)
tmpNumGroupH := cetimer_timerNumFromDpiAndFontSize(4, 6, 90, 100, 110)
...
tmpNumGroupW := cetimer_timerNumFromDpiAndFontSize(20, 23, 280, 300, 320)
tmpNumGroupH := cetimer_timerNumFromDpiAndFontSize(6, 6, 110, 120, 130)
...
tmpW := cetimer_timerNumFromDpiAndFontSize(3, 7, 55, 65, 75)
...
tmpNumGroupW := cetimer_timerNumFromDpiAndFontSize(26, 28, 430, 450, 470)
tmpNumGroupH := cetimer_timerNumFromDpiAndFontSize(8, 9, 185, 200, 215)
Gui, 24:Add, GroupBox, X10 y+5  w%tmpNumGroupW% h%tmpNumGroupH%
...
tmpNumGroupW := cetimer_timerNumFromDpiAndFontSize(11, 16, 420, 430, 450)
tmpNumGroupH := cetimer_timerNumFromDpiAndFontSize(8, 8, 150, 160, 170)
Gui, 27:Add, GroupBox, X10 y+10  w%tmpNumGroupW% h%tmpNumGroupH%

tmpW := cetimer_timerNumFromDpiAndFontSize(16, 17, 330, 350, 370)
...
tmpW := cetimer_timerNumFromDpiAndFontSize(5, 8, 40, 50, 60)
...
tmpW := cetimer_timerNumFromDpiAndFontSize(24, 26, 300, 320, 340)
